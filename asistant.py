...
class Window(QtWidgets.QMainWindow):
    ...
    def startAsistant(self):
        ...
        wakeword = 'bumblebee' #asistant name
        ...
        while True:
            ...
            if wakeword in query:
                ...
                if 'time' in query:
                    ...
                    try:        
                        print('gmail - hotmail - yahoo\nPlease select receiver email type: ')
                        speak('gmail - hotmail - yahoo\nPlease select receiver email type: ')
                    ...
                    while True:
                        try: 
                            ...
                            phone_no = '+' + takeCommandMIC().replace(' ','')
                            print(phone_no)
                    ...
                    self.ui.resultLebel.setText("Discord will be open!")
                    QtWidgets.qApp.processEvents()
